"This module contains NV_Optics class, which is a subclass of QSys"
...
class NV_Optics(QSys):
    """
    NV_optics class contains attributes and methods to simulate the nitrogen vacancy center in diamond
    with the excited states and optical transitions.
    ...
    RF_h1 : Qobj
        RF Hamiltonian
    Compose_excited: Qobj
        Create the excited state Hamiltonian and compose with the ground state Hamiltonian
    ...
    Notes
    -----
    The NV_Optics class inherits the methods and attributes from the QSys class.
    """
